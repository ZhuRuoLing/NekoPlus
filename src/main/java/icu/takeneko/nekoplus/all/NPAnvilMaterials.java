...
public class NPAnvilMaterials {
    public static final DeferredRegister<AnvilMaterial> DR = DeferredRegister.create(NPRegistries.MATERIAL, NekoPlus.MODID);
    ...
    public static final AnvilMaterial TITANIUM_ALLOY = register(
        ...
        AnvilMaterial.builder()
            ...
            .processRate(1)
            .color(0xC2D1DC)
            .anvilItem(NPBlocks.TITANIUM_ALLOY_ANVIL::asItem)
            .anvilBlock(NPBlocks.TITANIUM_ALLOY_ANVIL::get)
            .build()
    );
