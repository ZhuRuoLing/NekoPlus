...
//            .symbol('A', "highenergyanvilology:titanium_alloy_block")
//            .symbol('B', "anvilcraft:ember_glass")
//            .symbol('C', BlockPredicateWithState.of("highenergyanvilology:energy_output_hatch")
//                .hasState("facing", "west")
//            )
//            .symbol('D', BlockPredicateWithState.of("highenergyanvilology:item_output_hatch")
//                .hasState("facing", "east")
//            )
//            .symbol('E', BlockPredicateWithState.of("highenergyanvilology:item_input_hatch")
//                .hasState("facing", "south")
//            )
//            .symbol('F', BlockPredicateWithState.of("highenergyanvilology:fusion_reactor_controller")
//                .hasState("facing", "south")
//            )
//            .outputLayer("A")
//            .save(provider, HEAnvilology.location("fission_reactor"));

        MultiblockRecipe.builder("highenergyanvilology:fusion_reactor_controller", 1)
